#!/usr/bin/env bash
# VeriGate: one launcher for verifier-gated distillation and controlled baselines.
set -euo pipefail
...
export N_RESPONSES=${N_RESPONSES:-1}                 # group size for GRPD
